        ...
        <div class="container" style="padding-top: 50px;">
         <center>
            ...
            <div class="panel-heading" style="padding-bottom: 30px; padding-top : 0px;">
                <h3 style="color:#bd9c50;">USER COMPLAINTS </h3>
            </div>
...
$sql = "SELECT bu.Name,bu.Contact,b.Building_id,b.B_Name,bu.Room_id,bu.Room_no,bu.Room_type,c.Comp_id,c.Complaint_Message,c.User_id,c.photo FROM book_user bu join building b JOIN complaint c where b.User_id='alen_grace123' AND b.B_Name=c.B_Name";
...
while($row = $result->fetch_assoc())
{
  ...
  echo "<td>".$row['Complaint_Message']."</td>";  
  echo "<td>"."<img src='{$row['photo']}' class='complaint_image'>"."</td>";  
  echo '<td><button type="button" name="delete_btn" data-id3="'.$row["Comp_id"].'" class="btn btn-xs btn-danger btn_delete">x</button></td>';
  echo "</tr>";
}
}
//"<a href='{$row['photo']}'>{$row['photo']}</a>"
else 
{
  echo "0 results";
}
