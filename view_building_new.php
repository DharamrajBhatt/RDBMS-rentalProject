...
?>
                    ...
                    <div class="view-room-btn" style="margin-top: 50px;">
                       <a href="view_rooms.php" class="logout_btn" style="margin-top:50px; "><bold><i class="fas fa-person-booth"></i> VIEW ROOMS</bold></a>
                    </div>  
