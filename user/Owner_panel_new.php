            ...
            <div class="col-sm-6 col-lg-12">
                    ...
                    <div class="sidebar">
                        <center>
							...
							<span class="profile_image"><?= $_SESSION['pic'] ?></span>
							<br><br>
                            <h4>
							<?php
							echo $_SESSION['name']; 
						...
						<a href="view_building_new.php"><i class="fas fa-building"></i><span> Your Buildings</span></a>
						<a href="Booked_Room.php"><i class="fas fa-receipt"></i><span> Booked Room</span></a>
						<a href="view_user_complaints.php"><i class="fas fa-info-circle"></i><span> View User Complaints</span></a>
         ...
         <center>
          <div class="panel panel-info">
            <div class="panel-heading" style="padding-bottom: 30px; padding-top : 0px;">
                <h3 class="panel-title" style="color: #bd9c50;">
            ...
            <div class="panel-body">
              <div class="row">
				...
				<div class="img-circle img-responsive" width="300px;" height="200px;" style="border-radius: 50%;"><?= $_SESSION['pic'] ?></div>
				</div>
                  ...
                  <table class="table table-user-information">
                    <tbody>
                      ...
                      <tr>
						...
						<?php echo $_SESSION['mail']; ?></a></td>
                      </tr>
					    <tr>
                        <td>LOGIN TYPE</td>
                        <td> 
						<?php echo $_SESSION['utype']; ?>
						</td>
                      </tr>
                     <tr>
                        <td>CONTACT</td>
                        <td>
						<?php echo $_SESSION['con']; ?><br>
						</td>   
                      </tr>
                      <tr>
                        <td>REGISTER DATE</td>
                        <td>
						<?php echo $_SESSION['rdate']; ?>
						</td>
                      </tr>                             
                    </tbody>
                  </table>
