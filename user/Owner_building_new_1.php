        ...
        <div class="row">
            <div class="col-sm-6 col-lg-12">
                    ...
                    <div class="sidebar">
                        ...
                        <a href="Owner_panel_new.php"><i class="fas fa-info-circle"></i><span>Main Profile</span></a>
            ...
            <center>
              ...
              <div id="user_div">
                                        <div class="form-group input-group">
                                            ...
                                            <input name="b_id" class="form-control" placeholder="building Id" pattern="(?=.*\d)(?=.*[A-Z]).{1,5}" title="Must contain at least one number and one uppercase and lowercase letter.Must be Less than 7 Characters" type="text">
                ...
                <div id="fname_div">
						   <div class="form-group input-group">
                            ...
                            <div class="form-group input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"> <i class="fa fa-city fa_fa_color"></i> </span>
                                </div>
								<span id="type">
                                <select name="ct" class="form-control" id="city">
                                    <option selected=""> Select City</option>
                                    <option value="user">SURAT</option>
                                    <option value="owner">DELHI</option>
                                    <option value="owner">CHENNAI</option>
                                    <option value="owner">BANGLOURE</option>
                                </select>
								</span>
                            </div>
                            ...
                            <div id="add_div">
                                <div class="form-group input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"> <i class="fa fa-map-marked-alt fa_fa_color"></i> </span>
                                     </div>
                                    <input name="pin" class="form-control" placeholder="Pincode" type="text">
                                    <div id="add_error"></div>  
                                </div>
                             </div>
