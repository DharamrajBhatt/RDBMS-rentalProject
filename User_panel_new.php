        ...
        <div class="row">
            <div class="col-sm-6 col-lg-12">
                    ...
                    <div class="sidebar">
                        ...
                        <a href="User_profile_new.php"><i class="fas fa-info-circle"></i><span> View Profile</span></a>
						<a href="complain.php"><i class="fas fa-clipboard"></i><span> Put Your Complaint</span></a>
                        <a href="room_details.php"><i class="fas fa-person-booth"></i><span> Room Details</span></a>
