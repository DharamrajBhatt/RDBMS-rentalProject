    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-lg-12">
                    ...
                    <div class="sidebar">
                        <center>
                          <!--  <img src="img/propic3.jpg" class="profile_image">-->
						  <span class="profile_image"><?= $img ?></span>
						  <br><br>
                            <h4><?php echo 'Welcome'.' '.$_SESSION['name']; ?></h4>
                        </center>
                        <a href="User_profile_side.php"><i class="fas fa-info-circle"></i><span> View Profile</span></a>
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <div class="row">
				...
				<!--<img alt="User Pic" src="img/propic3.jpg" class="img-circle img-responsive" width="200px;" height="200px;" style="border-radius: 50%;">-->
				<div class="img-circle img-responsive" width="300px;" height="200px;" style="border-radius: 50%;"><?= $img ?></div>
				</div>
                <div class=" col-md-6 col-lg-6 "> 
                  <table class="table table-user-information">
                    <tbody>
                      ...
                      <tr>
                        <td>EMAIL ID</td>
                        <td><a href="mailto:info@support.com"><?php echo $_SESSION['mail']; ?></a></td>
                      </tr>
					    <tr>
                        <td>LOGIN TYPE</td>
