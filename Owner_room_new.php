        ...
        <div class="row">
            <div class="col-sm-6 col-lg-12">
                    ...
                    <div class="sidebar">
                        ...
                        <a href="view_building_new.php"><i class="fas fa-building"></i><span> Building Details</span></a>
...
?>
                       ...
                       <div id="age-div">
						...
						<div class="form-group input-group">
                                ...
                                <input  class="form-control" name="room_pic" type="file" required>
                            </div>  
                            <div class="form-group">
                                <button type="submit" name="room" type="submit" class="btn btn-block btncolor"><strong> Submit Room </strong></button>
                            </div> 
                        </form>
                    </article>
                </div>
