          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
			  ...
			  <div class="col-md-6 col-lg-6">
                <!--<div class="col-md-6 col-lg-6 onr-edit-img" align="center"><img alt="User Pic" src="" class="img-circle img-responsive" width="200px;" height="200px;" style="border-radius: 50%;">-->
					<div class="img-circle img-responsive" width="100px;" height="30px;" style="border-radius: 50%;position:absolute;top:5px"><?=$img?></div>
					
                </div>
                <div class=" col-md-6 col-lg-6 owner-edit-tbl"> 
				  ...
				  <div style="margin-top : 30px; margin-left: 95px;">
                   ...
                   <div style="padding-top : 35px; padding-left: 100px;">
